...
if ( !isset($_POST['fname']) || empty($_POST['fname'])
  ...
  if( $results_registered->num_rows > 0 ) {
    ...
    $sql = "INSERT INTO users(firstname, lastname, uscid, username, password, email, course)
      VALUES('" . $firstname . "','" . $lastname .  "','" . $uscid . "','".$username."','".$password."','".$email."','".$course."');";
...
<head>
  ...
  <title>Registration Confirmation | Find My CP</title>
  ...
  <div class="container">
    ...
    <div class="row mt-4">
      <div class="col-12">
        ...
        <?php else : ?>
          <div class="text-success"><?php echo $_POST['un']; ?> was successfully registered.</div>
        <?php endif; ?>
    </div> <!-- .col -->
  </div> <!-- .row -->
